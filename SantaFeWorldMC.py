...
class SantaFeEnv(discrete.DiscreteEnv):
    ...
    def __init__(self, shape=[32,32]):
        ...
        while not it.finished:
            ...
            is_done = lambda s: s == 759
            # is done at last food pellet, block 758
            ...
            if is_done(s):
                P[s][UP] = [(0.25, s, reward, True)]
                P[s][RIGHT] = [(0.25, s, reward, True)]
                P[s][DOWN] = [(0.25, s, reward, True)]
                P[s][LEFT] = [(0.25, s, reward, True)]
            ...
            # Not a terminal state
                ...
                P[s][UP] = [(0.25, ns_up, reward, is_done(ns_up))] 
                P[s][RIGHT] = [(0.25, ns_right, reward, is_done(ns_right))] 
                P[s][DOWN] = [(0.25, ns_down, reward, is_done(ns_down))] 
                P[s][LEFT] = [(0.25, ns_left, reward, is_done(ns_left))]
